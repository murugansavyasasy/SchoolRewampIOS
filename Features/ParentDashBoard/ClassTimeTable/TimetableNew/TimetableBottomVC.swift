...
class TimetableBottomVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tv.register(UINib(nibName: CellConfingName.TimetableTvCell, bundle: nil),
                    forCellReuseIdentifier: CellConfingName.TimetableTvCell)
        tv.delegate = self
        tv.dataSource = self
    ...
    func tableView(_ tableView: UITableView,
        ...
        let cell = tv.dequeueReusableCell(withIdentifier: CellConfingName.TimetableTvCell,
        ...
        cell.DurationLbl.text =  PTMString.duration.translated() + " - " + (data.duration ?? "")
        return cell
    }
