...
class MarkAttendenceVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        TV.register(UINib(nibName: CellConfingName.ReportAttCell, bundle: nil),forCellReuseIdentifier: CellConfingName.ReportAttCell)
    }
...
//                            }
                        ...
                        noStandardsLbl.isHidden = false
                        MarkAbsentiesBtn.isHidden = true
                        noStandardsLbl.text = successMessage.message ?? ""
                        sectionId = ""
                        StandardId = ""
                    }
                }
...
//                        }
                    ...
                    noStandardsLbl.isHidden = false
                    MarkAbsentiesBtn.isHidden = true
                    noStandardsLbl.text = error.localizedDescription
                    sectionId = ""
                    StandardId = ""
                }
            }
