...
//                    var item = nsString.substring(with: match.range(at: 1))
//                    
//                    // Replace HTML non-breaking space and decode any HTML entities if needed
//                    item = item.replacingOccurrences(of: "&nbsp;", with: " ")
//                    
//                    // Trim regular whitespace and non-breaking spaces
//                    item = item.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines.union(.init(charactersIn: "\u{00a0}")))
//                    
//                    results.append(item)
//                }
//            }
