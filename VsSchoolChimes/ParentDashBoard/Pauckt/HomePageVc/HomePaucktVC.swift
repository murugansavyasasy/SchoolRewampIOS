...
//                    } else {
//                        AllCouponsLbl.text = selectedCategory.categoryName
...
//                offer.campaignName?.lowercased().contains(searchText.lowercased()) == true ||
//                offer.merchantName?.lowercased().contains(searchText.lowercased()) == true ||
//                offer.categoryName?.lowercased().contains(searchText.lowercased()) == true
//            }
//        }
//        couponsCV.reloadData()
//    }
