...
class PrivewVc: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func confeeti(){
        if isAnimating {
            ...
            let alert = UIAlertController(title: "🎉 Great Job!", message: " That’s it! Homework done – you’re amazing!", preferredStyle: .alert)
...
//                      }
    ...
    func playVideo(for item: String) {
       ...
       private func getItemSize() -> CGSize {
           ...
           return CGSize(width: width, height: 100) // Height can be customized
       }
