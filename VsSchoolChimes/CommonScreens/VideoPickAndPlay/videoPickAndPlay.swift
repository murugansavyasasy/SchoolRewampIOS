...
//    // MARK: - Play Video
//
//    func playVideo(from url: URL, in container: UIView, below view: UIView) {
//        stopVideo()
//
...
//
//        container.insertSubview(playerVC.view, belowSubview: view) // insert below the button or imageView
