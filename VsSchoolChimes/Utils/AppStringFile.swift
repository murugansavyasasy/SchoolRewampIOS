...
struct CommonStringFile{
    ...
    static let RollNoDESC = "Roll No DSC".translated()
    static let AdmissionNoDESC = "Admission No DSC".translated()
    static let AdmissionNoASC = "Admission No ASC".translated()
    static let NameASC = "Name A-Z".translated()
    static let NameDESC = "Name Z-A".translated()
