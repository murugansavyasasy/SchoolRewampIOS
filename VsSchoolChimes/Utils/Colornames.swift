...
class ImageName{
    ...
    static let pdfImage = UIImage(named: "pdfImage")
    ...
    static let apsent = UIImage(named: "a")
    static let present = UIImage(named: "p")
    static let mic1 = UIImage(named: "mic 1")
    static let idCard = UIImage(named: "idCard")
    static let unnamed = UIImage(named: "unnamed")
