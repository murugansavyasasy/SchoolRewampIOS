...
class MenuRedirectHandler {
    ...
    var receiverItems : [String] = [ "Communication".translated(),"Homework".translated() ,"Exam/Test".translated(),"Exam Marks".translated(),"Image/Pdf".translated(),"Video".translated(),"Notice Board".translated(),"Assignment".translated(),"Online Meeting".translated(),"Attendance Report".translated(),"Events/Holidays".translated(),"Leave Requests".translated(),"Fee Details".translated(),"Images".translated(),"Interaction with Staff".translated(),"Quiz Exam".translated(),"LSRW".translated(),"Class Timetable".translated(),"Certificate Request".translated(),"PTM".translated()]
