...
//
//        if let notice = edit as? Report, let senderVC = pages[0] as? SenderAssignmentTextViewController {
...
//
//            if let senderVC = pages[1] as? AssignmentReport {
////                senderVC.Get_Notice()
//            }
//        }
//
...
//        if let historyVC = pages[1] as? AssignmentReport {
