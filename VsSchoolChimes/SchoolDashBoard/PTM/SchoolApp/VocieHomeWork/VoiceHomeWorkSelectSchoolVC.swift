//
//  VoiceHomeWorkSelectSchoolVC.swift
//  VoicesnapSchoolApp
//
...
class VoiceHomeWorkSelectSchoolVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        nc.addObserver(self,selector: #selector(VoiceHomeWorkSelectSchoolVC.catchNotification), name: NSNotification.Name(rawValue: "comeBackMenu"), object:nil)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "VoiceHomeworkSegue", sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        if (segue.identifier == "VoiceHomeworkSegue")
        {
            let segueid = segue.destination as! VoiceHomeWorkVC
